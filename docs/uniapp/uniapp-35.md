 ...
 **/
// #ifdef H5
import ClipboardJS from "@/components/utils/clipboard.js"
// #endif
const al = {
...
module.exports = {
	getClipboardData: al.getClipboardData
};
```
...
```js
const al = require("@/components/utils/clipboard-al.js");

methods: {
  clipboard: function(data) {
    al.getClipboardData(data, (res) => {
      //...
    })
  }
}
