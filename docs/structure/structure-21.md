...
-   [√ 配置多环境变量](https://staven630.github.io/vue-cli4-config/#env)
-   [√ 配置基础 vue.config.js](https://staven630.github.io/vue-cli4-config/#base)
-   [√ 配置 proxy 跨域](https://staven630.github.io/vue-cli4-config/#proxy)
-   [√ 修复 HMR(热更新)失效](https://staven630.github.io/vue-cli4-config/#hmr)
-   [√ 修复 Lazy loading routes Error： Cyclic dependency](https://staven630.github.io/vue-cli4-config/#lazyloading)
-   [√ 添加别名 alias](https://staven630.github.io/vue-cli4-config/#alias)
-   [√ 压缩图片](https://staven630.github.io/vue-cli4-config/#compressimage)
-   [√ 自动生成雪碧图](https://staven630.github.io/vue-cli4-config/#spritesmith)
-   [√ SVG 转 font 字体](https://staven630.github.io/vue-cli4-config/#font)
-   [√ 使用 SVG 组件](https://staven630.github.io/vue-cli4-config/#svg)
-   [√ 去除多余无效的 css](https://staven630.github.io/vue-cli4-config/#removecss)
-   [√ 添加打包分析](https://staven630.github.io/vue-cli4-config/#analyze)
-   [√ 配置 externals 引入 cdn 资源](https://staven630.github.io/vue-cli4-config/#externals)
-   [√ 多页面打包 multi-page](https://staven630.github.io/vue-cli4-config/#multiple-pages)
-   [√ 删除 moment 语言包](https://staven630.github.io/vue-cli4-config/#moment)
-   [√ 去掉 console.log](https://staven630.github.io/vue-cli4-config/#log)
-   [√ 利用 splitChunks 单独打包第三方模块](https://staven630.github.io/vue-cli4-config/#splitchunks)
-   [√ 开启 gzip 压缩](https://staven630.github.io/vue-cli4-config/#gzip)
-   [√ 开启 stylelint 检测scss, css语法](https://staven630.github.io/vue-cli4-config/#stylelint)
-   [√ 为 sass 提供全局样式，以及全局变量](https://staven630.github.io/vue-cli4-config/#globalscss)
-   [√ 为 less 提供全局样式，以及全局变量](https://staven630.github.io/vue-cli4-config/#globalless)
-   [√ 为 stylus 提供全局变量](https://staven630.github.io/vue-cli4-config/#globalstylus)
-   [√ 预渲染 prerender-spa-plugin](https://staven630.github.io/vue-cli4-config/#prerender)
-   [√ 添加 IE 兼容](https://staven630.github.io/vue-cli4-config/#ie)
-   [√ 静态资源自动打包上传阿里 oss、华为 obs](https://staven630.github.io/vue-cli4-config/#alioss)
-   [√ 完整依赖](https://staven630.github.io/vue-cli4-config/#allconfig)
...
还可以开启比 gzip 体验更好的 Zopfli 压缩详见<https://webpack.js.org/plugins/compression-webpack-plugin>
