...
下图可以直观的看出三者之间的区别: ![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/d0edee3e23b840adaad95c316d9a34c0~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image#?w=689&h=112&s=8462&e=webp&b=fefbf9) 其中蓝色代表 js 脚本网络加载时间，红色代表 js 脚本执行时间，绿色代表 html 解析。
